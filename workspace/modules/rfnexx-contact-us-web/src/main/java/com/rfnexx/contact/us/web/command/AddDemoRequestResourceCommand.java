...
@Component(property = { "javax.portlet.name=" + RfnexxContactUsWebPortletKeys.RFNEXXDEMOREQUESTWEB,
		"mvc.command.name=requestFormDemo" }, service = MVCResourceCommand.class)
public class AddDemoRequestResourceCommand implements MVCResourceCommand {
	...
	private static final Log log = LogFactoryUtil.getLog(AddDemoRequestResourceCommand.class);
