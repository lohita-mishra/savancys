...
/**
 * Provides the local service interface for LcaPosting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LcaPostingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LcaPostingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.savancys.service.impl.LcaPostingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the lca posting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LcaPostingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public LcaPosting addLcaPosting(
